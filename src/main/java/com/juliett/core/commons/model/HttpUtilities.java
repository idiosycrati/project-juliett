package com.juliett.core.commons.model;
...
public class HttpUtilities {
	...
	public String toString() {
		return "{" + " REQUEST_BASE_URL='" + getREQUEST_BASE_URL() + "'" + ", REQUEST_HEADERS='" + getREQUEST_HEADERS()
		...
		try {
			...
			if (connection.getResponseCode() != 200) {
				...
				throw new RuntimeException(
						"HTTP POST Request Failed with Error code : " + connection.getResponseCode());
			}
